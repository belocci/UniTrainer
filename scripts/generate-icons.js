...
const buildDir = path.join(__dirname, '..', 'assets', 'icons');
...
For macOS builds, you'll need to convert assets/icons/logo.png to icon.icns.
You can use one of these methods:

1. Online: https://cloudconvert.com/png-to-icns
   - Upload assets/icons/logo.png
   - Download and save as assets/icons/icon.icns
...
For now, Windows builds will work with assets/icons/icon.ico`;
    
    fs.writeFileSync(path.join(buildDir, 'ICNS_INSTRUCTIONS.txt'), icnsNote);
    console.log('✓ Icon generation complete!');
    console.log('\nWindows icon ready: assets/icons/icon.ico');
    console.log('See assets/icons/ICNS_INSTRUCTIONS.txt for Mac icon setup');
